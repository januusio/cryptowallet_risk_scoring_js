...
var _RiskScores = require("./RiskScores");
 ...
 * @version 1.0
 */
var RiskReport = /*#__PURE__*/function () {
  /**
   ...
   */
  function RiskReport(reasons, riskScores) {
    _classCallCheck(this, RiskReport);
   ...
   */
  _createClass(RiskReport, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new RiskReport();
        if (data.hasOwnProperty('reasons')) obj.reasons = _ApiClient.ApiClient.convertToType(data['reasons'], [_Reason.Reason]);
        if (data.hasOwnProperty('riskScores')) obj.riskScores = _RiskScores.RiskScores.constructFromObject(data['riskScores']);
      }
      return obj;
    }
  }]);
